...
///
/// **Copia deliberada** de `vehiculos/vista/cajon.dart`: el kit compartido
/// (`lib/diseno/cajon.dart` del PLAN §1) todavia no existe y una pantalla no
/// escribe en la carpeta de otra. Cuando el kit este, las dos copias se borran
/// y se importa aquel — y hasta entonces **cualquier cambio va en las dos**.
///

...
type Querier interface {
	...
	PorQueNoSePuedeArmar(ctx context.Context, arg PorQueNoSePuedeArmarParams) ([]PorQueNoSePuedeArmarRow, error)
	...
	QuitarPedidosDelEspejo(ctx context.Context, externalIds []string) (int64, error)
